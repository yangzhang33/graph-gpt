...
# ii. model config
model_name="medium"  # tiny mini small small12 medium medium24 medium48 base base24 base48 base64 large large48 xlarge xxlarge
stack_method="short"
stacked_feat_agg_method="gated"
hidden_act="gelu"  # llama -> `silu`, graphformer -> `gelu`
causal_attention=0
pretrain_cpt="pt_ns_h512_l8_b8192_mpe1024_tk1e9_gelu_pretrain3.3m_nmlm_mrlinear_mtp0.8_0_0.2_lr3e-4_adp0.1_pdp0_edp0_mdp0_lsi0_short_gated_wd0.1"
suffix_pt="_pt_b8192_tk4e9_3.3m_nmlm_mrlinear_mtp0.8_0_0.2_adp0.1_wd0.1"

# /datalake/datastore1/yang/graph-gpt/exp/models/pcqm4m-v2/202409/pt_ns_h256_l4_b8192_mpe1024_tk1e9_gelu_3.3m_nmlm_mrlinear_mtp0.8_0_0.2_lr3e-4_adp0.1_pdp0_edp0_mdp0_lsi0_short_gated_wd0.1
...
deepspeed --include localhost:1 ./examples/train_supervised.py ${raw_udf}
